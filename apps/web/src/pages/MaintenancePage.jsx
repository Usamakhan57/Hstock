...
const MaintenancePage = () => (
  <div className="min-h-screen grid place-items-center px-5 py-24 text-center bg-background">
    <Seo title="Under Maintenance" description="HStock is undergoing scheduled maintenance." noIndex />
    <div className="max-w-md">
      ...
      <p className="text-muted-foreground mt-2 leading-relaxed">
        HStock is undergoing scheduled maintenance to make things even better. Thanks for your patience — please check back shortly.
      </p>
      <button
