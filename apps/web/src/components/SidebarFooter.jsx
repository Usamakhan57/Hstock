  ...
  <div className="border-t border-[#E5E7EB] bg-white px-4 py-4">
    <div className="space-y-3">
      {footerLinks.map((link) => {
        const className = `inline-flex w-full items-center justify-center rounded-full px-4 py-3.5 text-sm font-semibold transition-all duration-200 ${link.primary
