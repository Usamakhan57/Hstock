...
export const seedProducts = [
  ...
  { id: 'prod-3', title: 'TikTok Viral Account — 200K Followers (Comedy)', slug: 'tiktok-viral-account-200k-comedy', sku: 'HS-TT-003', categoryId: 'cat-tiktok', collectionIds: [], brandId: 'brand-socialboost', tags: ['tiktok', 'social-account', 'comedy'], fileTypes: ['Account Transfer'], licenseIds: ['personal', 'commercial'], price: 349, salePrice: 299, cost: 80, stock: 2, lowStockThreshold: 1, status: 'active', featured: true, thumbnail: img.tiktok, gallery: [img.tiktok, img.social], previewImages: [img.tiktok], previewVideos: [], zipFile: null, description: 'A comedy-niche TikTok account with 200K followers and multiple videos past 1M views.', whatsIncluded: 'Full login transfer, content calendar handoff, and posting-history export.', metaTitle: 'TikTok Viral Account — 200K Followers | ApnaStore', metaDescription: 'Buy a comedy-niche TikTok account with 200K followers and viral video history.', rating: 4.8, reviewCount: 35, downloads: 0, createdAt: '2025-12-01T10:00:00.000Z' },
