...
function mergeSettings({ systemConfig, platformConfig, commissionConfig } = {}) {
  ...
  return {
    ...
    storePromotionEnabled: platform.storePromotionEnabled !== false,
    storePromotionPriceUsd: platform.storePromotionPriceUsd ?? 10,
    storePromotionDurationHours: platform.storePromotionDurationHours ?? 72,
    sellerVerificationEnabled: platform.sellerVerificationEnabled !== false,
    sellerVerificationFeeUsd: platform.sellerVerificationFeeUsd ?? 10,
    allowManualSellerVerification: platform.allowManualSellerVerification !== false,
...
export const updateSettings = async (form) => {
  const platformPayload = {
    ...
    storePromotionEnabled: !!form.storePromotionEnabled,
    storePromotionPriceUsd: Number(form.storePromotionPriceUsd) || 10,
    storePromotionDurationHours: Number(form.storePromotionDurationHours) || 72,
    sellerVerificationEnabled: !!form.sellerVerificationEnabled,
    sellerVerificationFeeUsd: Number(form.sellerVerificationFeeUsd) || 10,
    allowManualSellerVerification: !!form.allowManualSellerVerification,
