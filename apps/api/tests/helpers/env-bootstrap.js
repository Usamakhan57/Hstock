...
process.env.BUYER_WALLET_MIN_DEPOSIT = process.env.BUYER_WALLET_MIN_DEPOSIT || '5';
process.env.BUYER_WALLET_MAX_DEPOSIT = process.env.BUYER_WALLET_MAX_DEPOSIT || '10000';
