export const DISPUTE_TIMELINE_EVENTS = Object.freeze({
  ...
  BUYER_VIEWED_REPLACEMENT: 'buyer_viewed_replacement',
  BUYER_ACCEPTED_REPLACEMENT: 'buyer_accepted_replacement',
  BUYER_CLOSED_DISPUTE: 'buyer_closed_dispute',
  BUYER_REJECTED_REPLACEMENT: 'buyer_rejected_replacement',
